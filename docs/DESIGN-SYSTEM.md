...
- **Buttons:** 
  - *Primary:* Solid Electric Violet with white text. 8px border radius.
  - *Secondary:* White background with subtle #E5E7EB border and Slate Gray text.
...
- **Tabs:** 
  - *Pill style:* Active state uses a light violet background with primary violet text.
  - *Underline style:* 2px primary violet bottom border for active state with 600 weight text.
